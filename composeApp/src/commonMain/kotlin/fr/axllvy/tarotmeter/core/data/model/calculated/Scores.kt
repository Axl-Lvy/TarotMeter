 ...
 *
 * @property scores A map associating each [fr.axllvy.tarotmeter.core.data.model.Player] with their
 *   score as an [Int].
 */
@Immutable
data class Scores(val scores: Map<Player, Int>) {
  ...
  companion object {
     ...
     * configuration.
     *
     * @param round The [fr.axllvy.tarotmeter.core.data.model.Round] for which to calculate scores.
     * @param game The [fr.axllvy.tarotmeter.core.data.model.Game] context containing the players.
